...
const Footer: React.FC = () => {
  return (
    <footer
      ...
      id="contact"
    >
      <div className="flex w-full gap-6 text-base leading-7 flex-wrap max-md:max-w-full">
        <img
        ...
        />
        <div className="flex min-w-60 items-center gap-10 flex-wrap flex-1 shrink basis-[0%] max-md:max-w-full">
